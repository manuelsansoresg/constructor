...
class Setting extends Model
{
    ...
    public static function get($domain_id = null)
    {
        $domain = $domain_id == null ? Session::get('domain_id') : $domain_id;
        ...
        $get_builder = Builder::where(['name' => 'Inicio', 'slug' => '/', 'setting_id' => $setting->id])->first();
        if ($get_builder == null) {
            Builder::create(['name' => 'Inicio', 'slug' => '/', 'setting_id' => $setting->id]);
        }
        return $setting;
